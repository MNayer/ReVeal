# Found in data.zip @ https://drive.google.com/file/d/1Mn0jLaZWiPFQ8ejzlz_zXnx_TcSzbwu1
import argparse, os
import json
import numpy as np
...
if __name__ == '__main__':
    ...
    split_and_save(args.name + '-original', args.output, buggy, non_buggy, args.percent, True)
